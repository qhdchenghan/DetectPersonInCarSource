package ch.qhd.facedetectcamera.activity;
...
import ch.qhd.facedetectcamera.MainActivity;
import ch.qhd.facedetectcamera.R;
import ch.qhd.facedetectcamera.activity.ui.FaceOverlayView;
import ch.qhd.facedetectcamera.adapter.ImagePreviewAdapter;
import ch.qhd.facedetectcamera.model.FaceResult;
import ch.qhd.facedetectcamera.utils.CameraErrorCallback;
import ch.qhd.facedetectcamera.utils.ImageUtils;
import ch.qhd.facedetectcamera.utils.Util;
...
public final class FaceDetectGrayActivity extends AppCompatActivity implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    public void onCreate(Bundle icicle) {
        ...
        getSupportActionBar().setTitle("车内人员检测");
        if (icicle != null)
        ...
        Runnable runnable = new Runnable() {
            ...
            public void run() {
                ...
                MainActivity.onfind(3);
                handlertime.postDelayed(this, 1000);
            }
        };
        handlertime.postDelayed(runnable, 1000);//每1秒执行一次runnable.
    }
    ...
    private void setOptimalPreviewSize(Camera.Parameters cameraParameters, int width, int height) {
        ...
        if (width < height) {
            int tmp = prevSettingWidth;
            prevSettingWidth = prevSettingHeight;
            prevSettingHeight = tmp;
